...
%\item Η χρονική καθυστέρηση της καταγραφής των συναλλαγών απο τους consumers οφείλεται στο μεσοδιάστημα της προσθήκης δεδομένων στην κοινή ουρά απο τους producers και της επεξεργασίας τους απο τους consumers. Ο χρόνος δηλαδή που απαιτείται για την απελευθέρωση του κλειδιού, στον οποίο ευθύνεται και η συμμετοχήμ του scheduler, όταν καλείται ανα 1 λεπτό. 'Ετσι
